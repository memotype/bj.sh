...
bj()(set +u;[[ $1 = - ]]||exec<<<"$1";shift;r(){ l=$c;IFS= read -rN1 c;};p(){ printf %s \
"${o[@]}";};s(){ [[ $1 ]]||o=();while r;do [[ $1&&! $q ]]&&o+=("$l");case $c in \\)r||
break;[[ $1&&$q ]]||o+=("$l${c::!0$1}");;\")break;;*)[[ $1 ]]||o+=("$c");;esac;done;};k()\
...
[tfn0-9-])while o+=("$c")&&r&&[[ $c =~ [-+.0-9Ea-z] ]];do :;done;;*{)k;;*[)[[ $q = 0 ]]||
